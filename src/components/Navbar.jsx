...
const Navbar = () => {
  return (
    <>
      <div className="block lg:hidden absolute cursor-pointer w-fit p-4 h-fit">
        <MenuIcon />
      </div>
      <nav className=" hidden px-6 z-[100] py-10 bg-neutral-100 lg:w-[15%] border-r border-neutral-200/[0.8] fixed top-0 h-screen lg:relative  left-0 lg:flex flex-col justify-between max-w-[14rem]">
        ...
        >
          ...
          <div className="relative flex space-x-1 items-center z-10 rounded-full bg-transparent py-2 px-4 ring-1 ring-white/10 ">
            <a href="https://drive.google.com/file/d/1TGv-fG_C0wi2b_wuzyKh-hncgSWhHEXw/view?usp=sharing">Read Resume</a>
            <svg
              width="16"
              height="16"
              viewBox="0 0 24 24"
